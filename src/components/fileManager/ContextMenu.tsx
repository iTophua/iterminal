...
export function ContextMenu({
  ...
  const items: ContextMenuItemType[] = [
    ...
    { key: 'rename', label: '重命名', icon: <EditOutlined />, onClick: onRename, type: 'item' },
    { key: 'chmod', label: '修改权限', icon: <EyeOutlined />, onClick: onChmod, type: 'item' },
    { type: 'divider' },
    {
      key: 'download',
      label: '下载',
    ...
    { type: 'divider' },
    { key: 'compress', label: '压缩', icon: <CompressOutlined />, onClick: onCompress, type: 'item' },
    {
      key: 'extract',
      label: '解压',
