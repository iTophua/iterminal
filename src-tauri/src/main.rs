...
fn main() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            iterminal::commands::sftp::copy_path,
            ...
            iterminal::commands::ai::test_ai_connection,
            iterminal::commands::db::list_ai_conversations,
            ...
            iterminal::commands::db::count_mcp_logs,
            iterminal::commands::db::clear_mcp_logs,
            iterminal::commands::port_forward::start_port_forward,
            ...
            iterminal::commands::docker::remove_image,
            iterminal::commands::ssh::get_docker_shell,
            ...
            iterminal::commands::db::list_snippets,
            iterminal::commands::db::save_snippet,
            iterminal::commands::db::delete_snippet,
